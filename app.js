...
let audioHistory = []; 
let currentAudioSentence = { l1: "", l3: "" }; // Speichert den aktuellen Satz für den Button
...
async function audioTrainerLoop() {
    while (isAudioRunning && !cancelAudio) {
        ...
        currentAudioSentence = { l1: l1Text, l3: l3Text }; // Bereit zum Speichern
        ...
        // 4. Fremdsprache normal (Abschluss)
        if (cancelAudio) break;
        await speakAsync(l3Text, conf.l3, 1.0);
